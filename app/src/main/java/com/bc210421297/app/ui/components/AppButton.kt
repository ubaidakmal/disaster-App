...
import com.bc210421297.app.ui.theme.PrimaryColor
import com.bc210421297.app.ui.theme.TextOnPrimary
    ...
    Button(
        ...
        colors = ButtonDefaults.buttonColors(
            ...
            containerColor = if (isSecondary) 
                com.bc210421297.app.ui.theme.SecondaryColor 
            else 
                PrimaryColor,
            // Color when button is disabled (gray)
            disabledContainerColor = com.bc210421297.app.ui.theme.TextDisabled
        )
    ) {
        Text(
            text = text,
