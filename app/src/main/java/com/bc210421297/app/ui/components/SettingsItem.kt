...
import com.bc210421297.app.ui.theme.TextPrimary
import com.bc210421297.app.ui.theme.TextSecondary
...
fun SettingsItem(
    ...
    Card(
        ...
        colors = CardDefaults.cardColors(
            containerColor = com.bc210421297.app.ui.theme.SurfaceColor
        )
    ) {
        Row(
            modifier = Modifier
            ...
            Row(
                ...
                icon?.let {
                    Icon(
                        ...
                        tint = com.bc210421297.app.ui.theme.PrimaryColor,
                        modifier = Modifier
                            .size(24.dp)
                            .padding(end = 16.dp)
                    )
