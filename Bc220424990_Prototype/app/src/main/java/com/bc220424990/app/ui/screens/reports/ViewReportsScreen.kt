                ...
                uiState.errorMessage != null -> {
                    Column(
                        ...
                        Text(
                            ...
                            fontSize = 14.sp,
                            color = com.bc220424990.app.ui.theme.TextSecondary,
                            modifier = Modifier.padding(bottom = 16.dp)
                        )
                        com.bc220424990.app.ui.components.AppButton(
                            text = "Retry",
                    ...
                    val filteredReports = if (selectedTab == 0) {
                        ...
                        uiState.reports.filter { 
                            it.status == com.bc220424990.app.data.model.ReportStatus.ACTIVE 
                        }
                    } else {
